...
global using TokenValidationResult = IdentityServer8.Validation.TokenValidationResult;
global using Secret = IdentityServer8.Models.Secret;
global using static IdentityServer8.Constants;
global using Endpoint = IdentityServer8.Hosting.Endpoint;
global using ClaimValueTypes = System.Security.Claims.ClaimValueTypes;
global using AuthorizeResponse = IdentityServer8.ResponseHandling.AuthorizeResponse;